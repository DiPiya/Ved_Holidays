...
<!-- DC Pricing Tables:3 Start -->
    ...
    <script>
        jQuery(document).ready(function ($){
            $(".column_1, .column_3, .column_2, .column_4").click(function (){
                $('html, body').animate({
                    scrollTop: $(".ecfscrollto").offset().top
                }, 1500);
            });
        });
    </script>
    ...
    <div class="wrap">
        ...
        <h2><?php _e('Comparison', 'contact-form-lite'); ?></h2>   
  <div class="tsc_pricingtable03 tsc_pt3_style1" style="margin-bottom:110px; height:1100px;">
    <div class="caption_column">
      <ul>
        ...
        <li class="row_style_4"><span>+700 Fonts from Google Fonts</span></li>
        <li class="row_style_2"><span>Show Form from Link / Image</span></li>
        ...
        <li class="row_style_2"><span>Support Department Field</span></li>
        ...
        <li class="footer_row ecfscrollto"></li>
      </ul>
    </div>
    <div class="column_1">
      <ul>
    ...
    <div class="column_2">
      <ul>
        ...
        <li class="row_style_2 align_center"><span style="font-weight: bold; color:#F77448; font-size:14px;">1 Site</span></li>
        <li class="footer_row"><a target="_blank" href="http://ghozylab.com/plugins/ordernow.php?order=ecfpro&utm_source=contactform&utm_medium=pricingpage&utm_campaign=pricingpage" class="tsc_buttons2 blue">Upgrade Now</a></li>
      </ul>
    </div>    
    ...
    <span class="bestbuy"></span>
      <ul>
        ...
        <li class="row_style_4 align_center"><span>1 Year</span></li>
        <li class="row_style_2 align_center"><span style="font-weight: bold; color:#F77448; font-size:14px;">3 Sites</span></li>
        <li class="footer_row"><a target="_blank" href="http://ghozylab.com/plugins/ordernow.php?order=ecfproplus&utm_source=contactform&utm_medium=pricingpage&utm_campaign=pricingpage" class="tsc_buttons2 orange">Upgrade Now</a></li>
      </ul>
    </div>
    <div class="column_2">
      <ul>
        ...
        <li class="row_style_4 align_center"><span>1 Year</span></li>
        <li class="row_style_2 align_center"><span style="font-weight: bold; color:#F77448; font-size:14px;">5 Sites</span></li>
        <li class="footer_row"><a target="_blank" href="http://ghozylab.com/plugins/ordernow.php?order=ecfproplusplus&utm_source=contactform&utm_medium=pricingpage&utm_campaign=pricingpage" class="tsc_buttons2 green">Upgrade Now</a></li>
      </ul>
    </div>    
     <div class="column_4">
      <ul>
